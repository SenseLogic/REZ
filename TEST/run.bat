...
..\rez --read-png test.png 1 --vectorize 128 0.01 --write-svg OUT/test_simplified.svg 1 --write-obj OUT/test_simplified.obj 2.5
..\rez --read-png blueprint.png 0.03 --vectorize 128 0 --write-svg OUT/blueprint.svg 1 --write-obj OUT/blueprint.obj 2.5
..\rez --read-png blueprint.png 0.03 --vectorize 128 0.5 --write-svg OUT/blueprint_simplified.svg 1 --write-obj OUT/blueprint_simplified.obj 2.5
pause
