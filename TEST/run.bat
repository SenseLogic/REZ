..\rez --read-png dot.png 1 --vectorize 255.255.255 128 2.5 --write-svg OUT/dot.svg --write-obj OUT/dot.obj
..\rez --read-png square.png 1 --vectorize 255.255.255 128 2.5 --write-svg OUT/square.svg --write-obj OUT/square.obj
