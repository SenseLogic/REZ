...
../rez --read-png test.png 1 --vectorize 255.255.255 128 0.1 2.5 --simplify 0.01 --write-svg OUT/test_simplified.svg --write-obj OUT/test_simplified.obj
../rez --read-png blueprint.png 0.03 --vectorize 255.255.255 128 1 2.5 --write-svg OUT/blueprint.svg --write-obj OUT/blueprint.obj
../rez --read-png blueprint.png 0.03 --vectorize 255.255.255 128 1 2.5 --simplify 0.5 --write-svg OUT/blueprint_simplified.svg --write-obj OUT/blueprint_simplified.obj
